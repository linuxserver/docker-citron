pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'CITRON_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-citron'
    CONTAINER_NAME = 'citron'
    DOCKERHUB_IMAGE = 'linuxserver/citron'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/citron'
    PR_DOCKERHUB_IMAGE = 'lspipepr/citron'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-citron/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-citron\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-citron\" \
          ...
          --label \"org.opencontainers.image.description=[Citron](https://citron-emu.org/) is a feature rich Switch 1 emulator for homebrew.\" \
